...
class TestRecommendItemsToUser: RecombeeTest() {
    ...
    fun callbackTest() {
        ...
        val request = RecommendItemsToUser("user-1", 5, logic=Logic("recombee:popular", settings = mutableMapOf("timePeriod" to 100000)))
